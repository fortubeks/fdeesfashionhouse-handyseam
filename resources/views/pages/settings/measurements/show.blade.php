      ...
      <div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary">
            ...
            {{ __('Add or Remove Measurement Details necessary for taking your customer measurements') }}
            </div>
          <div class="card-body">
            <div class="">
                <form action="{{ url('/update-measurement-settings') }}" method="post" accept-charset="UTF-8" >
                @csrf
                <div class="col-md-6">
                  @php
                ...
                <div class="col-md-12">
                    @if(isset($_GET['customer_id']) && isset($_GET['origin']))
                    <input name="origin" type="hidden" value="{{$_GET['origin']}}">
                    <input name="customer_id" type="hidden" value="{{$_GET['customer_id']}}">
                    @endif
