...
<div class="content">
    <div class="container-fluid">
        ...
        <form action="{{ url('orders/'.$order->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row img-thumbnail mb-3" style="padding:20px;">
                        <div class="col-md-8 vertical-align">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="form-control"> <?php if ($outfit->customer) {
                                                                        echo $outfit->customer->name;
                                                                    } else {
                                                                        echo 'Customer:';
                                                                    } ?> </label>
                                </div>
