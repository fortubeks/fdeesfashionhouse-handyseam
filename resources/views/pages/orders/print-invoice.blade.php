        ...
        <table class="table-data">
            ...
            <!-- <tfoot> --> 
                ...
                <tr style="background-color:#ddd;">
                    <td class="centered" colspan="5">{{__('Served By')}}: {{__(auth()->user()->name)}}</td>
                </tr>                
                <tr><td class="centered" colspan="5">{{__('Thank you. Please come again')}}</td></tr>
                @if(!auth()->user()->user_account->isPremiumUser())
                <tr><td class="centered" colspan="5"><div class="centered" style="margin:30px 0 50px">
                    <small>{{__('Invoice Generated By')}} {{__('HandySeam')}}.
                    {{__('Developed By')}} Fortran House</small>
                    </div></td>
                </tr>
                @endif
            </tbody>
