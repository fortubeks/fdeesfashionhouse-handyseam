...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/logo/handyseam_logo.png" />
    <title>{{ __('Handyseam - The Best App To Manage Your Fahion & Tailoring Business') }}</title>
...
<div style="max-width:400px;margin:0 auto">
    ...
    <div class="hidden-print">
        <table>
            <tr>
                ...
                <td><button type="button" onclick="window.print()" class="btn btn-primary"><i class="dripicons-print"></i> {{'Print'}}</button></td>
            </tr>
        </table>
        <br>
    </div>
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <img src="{{ asset('material') }}/img/logo/handyseam_logo.png" height="42" width="50" style="margin:10px 0;filter: brightness(0);">
